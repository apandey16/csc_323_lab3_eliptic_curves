...
ellipticCurve = ellipticCurve(-95051, 11279326, 233970423115425145524320034830162017933)
basePoint = regularPoint(ellipticCurve, 182, 85518893674295321206118380980485522083)
basePointOrder = 29246302889428143187362802287225875743

publicKey = regularPoint(ellipticCurve, x, y)
